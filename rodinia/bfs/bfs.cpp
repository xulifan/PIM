...
int main(int argc, char * argv[])
{
	...
	try{
        ...
        // input file format:
        // num of nodes
        // node0 starting edge number, number of edges starting from node0
        // ...
        // noden starting edge number, number of edges starting from noden
        //
        // root node number
        //
        // number of edges
        // edge0 ending node; edge0 weight
        // ...
        // edgem ending node; edgem wight
		...
		//---------------------------------------------------------
		//--gpu entry
		run_bfs_pim(no_of_nodes,h_graph_nodes,edge_list_size,h_graph_edges, h_graph_mask, h_updating_graph_mask, h_graph_visited, h_cost);	
		//---------------------------------------------------------
		//--cpu entry
