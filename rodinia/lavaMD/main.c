...
#include "./util/timer/timer.c"	
#include "./util/num/num.c"
#include "./util/opencl/opencl.c"	
#include "./kernel/kernel_gpu_opencl_wrapper.c"
#include "kernel_pim.c"
...
//	kernel_gpu_opencl_wrapper(	par_cpu,dim_cpu,box_cpu,rv_cpu,qv_cpu,fv_cpu);
    ...
    kernel_pim_wrapper(	par_cpu,dim_cpu,box_cpu,rv_cpu,qv_cpu,fv_cpu);
