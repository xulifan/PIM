...
__kernel void 
nw_kernel1_pim(__global int  * reference_d, 
		   __global int  * input_itemsets_d, 
		   __global int  * output_itemsets_d, 
		   __local	int  * input_itemsets_l,
		   __local	int  * reference_l,
...
{  
	...
	// Block index
    int bx = get_group_id(0)+start_point;	
	//int bx = get_global_id(0)/BLOCK_SIZE;
   ...
   for ( int ty = 0 ; ty < BLOCK_SIZE ; ty++)  input_itemsets_d[index + cols * ty] = SCORE((ty+1), (tx+1));
...
__kernel void 
nw_kernel2_pim(__global int  * reference_d, 
		   __global int  * input_itemsets_d, 
		   __global int  * output_itemsets_d, 
		   __local	int  * input_itemsets_l,
		   __local	int  * reference_l,
