		...
		if (point_id < npoints)
		{
			...
			for (int i=0; i < nclusters; i++) {
				...
				for (int l=0; l<nfeatures; l++){
						...
						//	   (feature[l * npoints + point_id]-clusters[i*nfeatures+l]);    //duplicated global memory access, can be optimized
                        float temp = feature[l * npoints + point_id]-clusters[i*nfeatures+l];
                        ans += temp * temp;
				}
